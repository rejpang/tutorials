...
public class User {
    ...
    @Column(
        name = "phone_numbers", columnDefinition = "text[]"
    )
    ...
    public Integer[] getLocations() { return locations; }

    public void setLocations(Integer[] locations) { this.locations = locations; }
